package com.ada.library.api.exceptionhandler;
...
import com.ada.library.api.exceptionhandler.enums.ProblemType;
import com.ada.library.domain.exception.BusinessException;
import com.ada.library.domain.exception.EntityNotFoundException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public static final String END_USER_GENERIC_ERROR_MSG
		= "An anexpected error accurred. Try again and if "
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, 
		...
		String detail = String.format("The resource %s you tried to acces does not exist.", 
				ex.getRequestURL());
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		String detail = "The request body is invalid. Check any syntax error.";
	...
	private ResponseEntity<Object> handleInvalidFormat(InvalidFormatException ex,
		...
		String detail = String.format("The property '%s' received the value '%s', "
				+ "which is an invalid one. Correct and enter a value compatible with type %s.",
	...
	public ResponseEntity<?> handleEntidadeEmUso(EntityUsedException ex, WebRequest request) {
		
		HttpStatus status = HttpStatus.CONFLICT;
		ProblemType problemType = ProblemType.USED_ENTITY;
		String detail = ex.getMessage();
